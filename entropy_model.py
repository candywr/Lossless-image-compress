...
class GaussianConditional_LossLess(EntropyModel):
...
class GaussianMixtureConditional(EntropyModel):
    ...
    *tensorflow/compression*. See the `tensorflow documentation
    ...
    #GMM
    def forward(self, inputs, scales, means=None,weights=None):
...
if __name__ == '__main__':
    ...
    a = GaussianMixtureConditional(3)
    # zeros = ops.Zeros()
    x = torch.zeros((16, 128, 4, 4))
    out, likeli = a(x)
